...
public class ArabicReshaper{
	...
	public static char DEFINED_CHARACTERS_ORGINAL_ALF_UPPER_MDD = (char)int.Parse("0622", NumberStyles.AllowHexSpecifier);
	
	
	public static char DEFINED_CHARACTERS_ORGINAL_ALF_UPPER_HAMAZA = (char)int.Parse("0623", NumberStyles.AllowHexSpecifier);
	
	
	public static char DEFINED_CHARACTERS_ORGINAL_ALF_LOWER_HAMAZA = (char)int.Parse("0625", NumberStyles.AllowHexSpecifier);	
	
	
	public static char DEFINED_CHARACTERS_ORGINAL_ALF = (char)int.Parse("0627", NumberStyles.AllowHexSpecifier);
	
	
	public static char DEFINED_CHARACTERS_ORGINAL_LAM	= (char)int.Parse("0644", NumberStyles.AllowHexSpecifier);
	
	
	
	
	public static char[][] LAM_ALEF_GLPHIES= new char[][]
	{	new char[]{(char)15270,(char)65270, (char)65269},
		new char[]{(char)15271,(char)65272, (char)65271},
		new char[]{(char)1575, (char)65276, (char)65275},
		new char[]{(char)1573, (char)65274, (char)65273}
	};
	...
	{new char[]{ '\u0622','\uFE81','\uFE81','\uFE82','\uFE82',(char)2 } ,
		new char[]{ '\u0623','\uFE83','\uFE83','\uFE84','\uFE84',(char)2 } ,
		new char[]{ '\u0624','\uFE85','\uFE85','\uFE86','\uFE86',(char)2 } ,
		new char[]{ '\u0625','\uFE87','\uFE87','\uFE88','\uFE88',(char)2 } ,
		new char[]{ '\u0626','\uFE89','\uFE8B','\uFE8C','\uFE8A',(char)4 } ,
		new char[]{ '\u0627','\u0627','\u0627','\uFE8E','\uFE8E',(char)2 } ,
		new char[]{ '\u0628','\uFE8F','\uFE91','\uFE92','\uFE90',(char)4 } ,
		new char[]{ '\u0629','\uFE93','\uFE93','\uFE94','\uFE94',(char)2 } ,
		new char[]{ '\u062A','\uFE95','\uFE97','\uFE98','\uFE96',(char)4 } ,
		new char[]{ '\u062B','\uFE99','\uFE9B','\uFE9C','\uFE9A',(char)4 } ,
		new char[]{ '\u062C','\uFE9D','\uFE9F','\uFEA0','\uFE9E',(char)4 } ,
		new char[]{ '\u062D','\uFEA1','\uFEA3','\uFEA4','\uFEA2',(char)4 } ,
		new char[]{ '\u062E','\uFEA5','\uFEA7','\uFEA8','\uFEA6',(char)4 } ,
		new char[]{ '\u062F','\uFEA9','\uFEA9','\uFEAA','\uFEAA',(char)2 } ,
		new char[]{ '\u0630','\uFEAB','\uFEAB','\uFEAC','\uFEAC',(char)2 } ,
		new char[]{ '\u0631','\uFEAD','\uFEAD','\uFEAE','\uFEAE',(char)2 } ,
		new char[]{ '\u0632','\uFEAF','\uFEAF','\uFEB0','\uFEB0',(char)2 } ,
		new char[]{ '\u0633','\uFEB1','\uFEB3','\uFEB4','\uFEB2',(char)4 } ,
		new char[]{ '\u0634','\uFEB5','\uFEB7','\uFEB8','\uFEB6',(char)4 } ,
		new char[]{ '\u0635','\uFEB9','\uFEBB','\uFEBC','\uFEBA',(char)4 } ,
		new char[]{ '\u0636','\uFEBD','\uFEBF','\uFEC0','\uFEBE',(char)4 } ,
		new char[]{ '\u0637','\uFEC1','\uFEC3','\uFEC4','\uFEC2',(char)4 } ,
		new char[]{ '\u0638','\uFEC5','\uFEC7','\uFEC8','\uFEC6',(char)4 } ,
		new char[]{ '\u0639','\uFEC9','\uFECB','\uFECC','\uFECA',(char)4 } ,
		new char[]{ '\u063A','\uFECD','\uFECF','\uFED0','\uFECE',(char)4 } ,
		new char[]{ '\u0641','\uFED1','\uFED3','\uFED4','\uFED2',(char)4 } ,
		new char[]{ '\u0642','\uFED5','\uFED7','\uFED8','\uFED6',(char)4 } ,
		new char[]{ '\u0643','\uFED9','\uFEDB','\uFEDC','\uFEDA',(char)4 } ,
		new char[]{ '\u0644','\uFEDD','\uFEDF','\uFEE0','\uFEDE',(char)4 } ,
		new char[]{ '\u0645','\uFEE1','\uFEE3','\uFEE4','\uFEE2',(char)4 } ,
		new char[]{ '\u0646','\uFEE5','\uFEE7','\uFEE8','\uFEE6',(char)4 } ,
		new char[]{ '\u0647','\uFEE9','\uFEEB','\uFEEC','\uFEEA',(char)4 } ,
		new char[]{ '\u0648','\uFEED','\uFEED','\uFEEE','\uFEEE',(char)2 } ,
		new char[]{ '\u0649','\uFEEF','\uFEEF','\uFEF0','\uFEF0',(char)2 } ,			
		new char[]{ '\u0671','\u0671','\u0671','\uFB51','\uFB51',(char)2 },
		new char[]{ '\u064A','\uFEF1','\uFEF3','\uFEF4','\uFEF2',(char)4 },
		new char[]{ '\u066E','\uFBE4','\uFBE8','\uFBE9','\uFBE5',(char)4 },         
		new char[]{ '\u0671','\u0671','\u0671','\uFB51','\uFB51',(char)2 },       
		new char[]{'\u06AA','\uFB8E','\uFB90','\uFB91','\uFB8F',(char)4 },       
		new char[]{ '\u06C1','\uFBA6','\uFBA8','\uFBA9','\uFBA7',(char)4 },      
		new char[]{'\u06E4','\u06E4','\u06E4','\u06E4','\uFEEE',(char)2 }
	};
	 ...
	 * @return
	 */
	private static bool isHaraka(char target) {
	...
	private string replaceLamAlef(string unshapedWord) {
		...
		wordLetters = unshapedWord.ToCharArray();		
		char letterBefore = (char)0;
		...
		unshapedWord = unshapedWord.Replace(" ", "");
	 ...
	 */
	private  char getLamAlef(char candidateAlef,char candidateLam,bool isEndOfWord){
		//The shift rate, depends if the the end of the word or not!
		int shiftRate = 1;
		
		//The reshaped Lam Alef
		char reshapedLamAlef = (char)0;
	 ...
	 * 
	 */
	public class DecomposedWord {
		char[] stripedHarakates ;
		int[] harakatesPositions;
		public char[] stripedRegularLetters;
		 ...
		 * @param unshapedWord
		 */
		public DecomposedWord(string unshapedWord) {
			int wordLength = unshapedWord.Length;
			int harakatesCount = 0;
			for(int index = 0; index < wordLength; index++ ) {
				if (isHaraka(unshapedWord.ToCharArray()[index])) {
					harakatesCount++;
				}
			}
			...
			for(int index = 0; index < unshapedWord.Length; index++ ) {
				if (isHaraka(unshapedWord.ToCharArray()[index])) {
					...
					stripedHarakates[harakatesCount] = unshapedWord.ToCharArray()[index];
					harakatesCount++;
				} else {
					lettersPositions[letterCount] = index;
						stripedRegularLetters[letterCount] = unshapedWord.ToCharArray()[index];
					letterCount++;
				}
			}
		}
		 ...
		 * @return
		 */
		public string reconstructWord(string reshapedWord) {
			...
			for(int index = 0; index < lettersPositions.Length; index++) {
				wordWithHarakates[lettersPositions[index]] = reshapedWord.ToCharArray()[index];
			}
